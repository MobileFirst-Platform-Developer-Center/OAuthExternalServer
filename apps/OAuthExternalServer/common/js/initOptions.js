...
// Uncomment the initialization options as required. For advanced initialization options please refer to IBM MobileFirst Platform Information Center
 ...
 var wlInitOptions = {
	...
	// # Should application automatically attempt to connect to MobileFirst Server on application start up
	...
	// - url - server that receives the analytics data (default: [mobilefirst-server]/analytics)
	analytics : {
		enabled: false
		//url : ''
	}
